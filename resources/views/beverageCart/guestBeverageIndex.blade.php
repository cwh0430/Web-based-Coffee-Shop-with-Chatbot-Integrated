                                ...
                                <div>
                                    ...
                                    <div class="pl-md-0">
                                        ...
                                        <input type="number" min="1" value="{{$item->quantity}}"
                                            id="quantity-input-{{$item->id}}" model-type="Beverage" />
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-10 col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="px-md-0 px- footer-font">
                        <b class="ps-md-4">SUBTOTAL<span class="ps-md-4" id="subtotal"> RM{{number_format($subTotal,2,
                                '.')}}</span></b>
                    </div>
                    <div>
