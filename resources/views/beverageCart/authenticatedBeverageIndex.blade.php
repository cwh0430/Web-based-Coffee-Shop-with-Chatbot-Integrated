                            ...
                            <div class="col-xl-2 col-lg-2 col-md-2 d-flex justify-content-start"
                                ...
                                <div>
                                    <p class="small text-muted mb-4 pb-2 quantity-label">
                                        Quantity</p>
                                    <div class="pl-md-0">
                                        <span><button onclick="userMinusQuantity('{{$beverage->pivot->id}}')"
                                                class="btn" id="minus-btn-{{$beverage->pivot->id}}"><i
                            ...
                            <div class="row d-flex d-sm-flex flex-column flex-sm-column col-8">
                                ...
                                <div class=" col-12 col-sm-12 d-flex d-sm-flex justify-content-start mt-2 ms-2">
                                    <div>
                                        <p class="lead fw-normal mb-0"> RM
                                            {{number_format($beverage->pivot->sub_price,2,
                                            '.')}}</p>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex d-sm-flex">
                                    ...
                                    <div class="col-4 col-sm-4 d-flex d-sm-flex justify-content-start mt-2"
                                        ...
                                        <div>
                                            <div class="pl-md-0">
                                                <span><button onclick="minusQuantity('{{$beverage->pivot->id}}')"
                                                        class="btn"
                                                        id="minus-btn-{{$beverage->pivot->id}}-responsive"><i
                                                            class="fa-solid fa-minus"></i></button></span>
                                                <input type="number" min="1" value="{{$beverage->pivot->quantity}}"
                                                    id="quantity-input-{{$beverage->pivot->id}}-responsive"
                                                    model-type="Beverage" />
                                                <span><button onclick="addQuantity('{{$beverage->pivot->id}}')"
                                                        class="btn" id="plus-btn-{{$beverage->pivot->id}}-responsive"><i
                                                            class="fa-solid fa-plus"></i></button></span>
                                            </div>
                                        </div>
                                    </div>
