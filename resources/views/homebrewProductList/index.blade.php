    ...
    <div class="container-fluid mt-5 mb-5">
        ...
        <div class="row">
            <div class="col-xl-8 col-md-8 col-sm-12 col-12">
                ...
                @if (sizeof($homebrewProducts) > 0)
                <div class="row me-lg-4 me-md-4 mb-sm-5 mb-xl-0 mb-lg-0 mb-md-0 mb-5 row-small-width">
                    @foreach ($homebrewProducts as $homebrewProduct)
                    <div class="col-xl-4 col-md-6 col-sm-8 col-8 borders-line">
                        <a href="/showhomebrewproduct/{{$homebrewProduct->id}}">
                            <div class="img-div">
                                <img src="storage/{{$homebrewProduct->img}}" alt="product" class="img-fluid" />
                            </div>

                            <p class="product-name">{{$homebrewProduct->name}}</p>
                        </a>
                        <div class="price-container">
                            <p class="price"> RM {{number_format($homebrewProduct->price,2, '.')}}</p>

                            <form action="{{ url('/addproductcart') }}" method="POST">
                                @csrf
                                ...
                                <button type="submit" class="add-to-cart-responsive d-block d-xl-none">ADD TO
                                    CART
                                    <i class="fa-solid fa-plus"></i>
                                </button>
                            </form>
            ...
            <div class="col-xl-3 col-md-3 col-sm-8 col-8">
                ...
                <div>
                    ...
                    <form method="GET" action="{{route('homebrewproductlist')}}">
                        @csrf
