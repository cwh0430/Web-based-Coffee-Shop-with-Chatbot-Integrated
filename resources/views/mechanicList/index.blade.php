    ...
    <div class="container-fluid mt-5 mb-5">
        ...
        <div class="row">
            <div class="col-xl-8 col-md-8 col-sm-12 col-12">
                ...
                <div class="row me-lg-4 e-md-4 mb-sm-5 mb-xl-0 mb-lg-0 mb-md-0 mb-5 row-small-width">
                    @foreach ($mechanics as $mechanic)
                    <div class="col-xl-4 col-md-6 col-sm-8 col-8 borders-line">
                        <a href="/showmechanic/{{$mechanic->id}}">

                            <div class="img-div">
                                <img src="storage/{{$mechanic->img}}" alt="product" class="img-fluid" />
                            </div>

                            <p class="product-name">{{$mechanic->name}}</p>
                        </a>
                        <div class="price-container">
                            <p class="price"> RM {{number_format($mechanic->price,2, '.')}}</p>
            ...
            <div class="col-xl-3 col-md-3 col-sm-8 col-8">
                ...
                <div>
                    ...
                    <form method="GET" action="{{route('mechaniclist')}}">
                        @csrf
